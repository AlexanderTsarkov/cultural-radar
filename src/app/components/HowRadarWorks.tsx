...
const STEPS = [
  ...
  },
  {
    number: "02",
    title: "Выбор",
    body: "Полина разбирает каждое предложение отдельно: само событие и город, ради которого имеет смысл поехать.",
  },
  {
    number: "03",
    title: "Следующий акт",
    body: "Собранный результат уходит художественному совету: он сверяет интерес с реальными программами, датами и билетной реальностью.",
  },
] as const;
